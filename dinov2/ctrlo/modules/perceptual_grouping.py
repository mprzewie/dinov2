...
from dinov2.ctrlo.nns.tensor_ops import pixel_norm
...
class SlotAttentionGrouping(nn.Module):
    ...
    def forward(
        self,
        feature: typing.FeatureExtractorOutput,
        conditioning:  typing.ConditioningOutput,
        slot_mask: Optional[typing.EmptyIndicator] = None,
    ) -> typing.PerceptualGroupingOutput:
        ...
        return typing.PerceptualGroupingOutput(
...
class ControllableSlotAttentionGrouping(nn.Module):
    ...
    def forward(
        self,
        feature: typing.FeatureExtractorOutput,
        conditioning:  typing.ConditioningOutput = None,
        dual_conditioning:  typing.ConditioningOutput = None,
        point_conditioning:  typing.ConditioningOutput = None,
        lang_conditioning:  typing.ConditioningOutput = None,
        slot_mask: Optional[typing.EmptyIndicator] = None,
    ) -> typing.PerceptualGroupingOutput:
        """Apply slot attention based perceptual grouping.
        ...
        if dual_attn_list is None:
            return typing.ControllablePerceptualGroupingOutput(
                slots,
                dual_slots,
                point_slots,
                lang_slots,
...
class StickBreakingGrouping(nn.Module):
    ...
    def forward(
        self, features: typing.FeatureExtractorOutput
    ) -> typing.PerceptualGroupingOutput:
...
class KMeansGrouping(nn.Module):
    ...
    def forward(
        self, feature:  typing.FeatureExtractorOutput
    ) -> typing.PerceptualGroupingOutput:
