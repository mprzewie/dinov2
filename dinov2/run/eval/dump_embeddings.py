...
from dinov2.eval.dump_embeddings_for_linear import get_args_parser as get_dump_embeddings_args_parser
...
class Evaluator:
    ...
    def __call__(self):
        from dinov2.eval.dump_embeddings_for_linear import main as dump_embeddings_main

        self._setup_args()
        dump_embeddings_main(self.args)
...
def main():
    ...
    log_regression_args_parser = get_dump_embeddings_args_parser(add_help=False)
