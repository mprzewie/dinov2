...
class SelectConditioningInfo:
    ...
    def __init__(self, embeddings_path: str,num_max_binds: int = 3, num_slots: int = 33, is_refcocog: bool = False):
...
class SelectConditioningInfoVG:
    ...
    def __init__(self, embeddings_path: str, num_max_binds: int = 3, num_slots: int = 7):
        """Initialize SelectConditioningInfo.
